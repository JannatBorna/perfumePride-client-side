...
function Dashboard (props) {
    ...
    const drawer = (
        ...
        <div>
            ...
            <Link to="/dashboard"><Button color="inherit">Pay</Button></Link>
            <Link to="/dashboard"><Button color="inherit">My Order</Button></Link>
            <Link to="/dashboard"><Button color="inherit">Reviews</Button></Link> */}
